...
var swfobject = function() {
                    ...
                    if (ae) {
                        if (F(o[af].swfVersion) && !(M.wk && M.wk < 312)) {
                            ...
                            if (o[af].expressInstall && A()) {
                                ...
                                var ac = X.length;
                                for (var ad = 0; ad < ac; ad++) { if (X[ad].getAttribute("name").toLowerCase() != "movie") { ah[X[ad].getAttribute("name")] = X[ad].getAttribute("value") } }
                                P(ai, ah, Y, ab)
    ...
    function p(Y) {
        if (M.ie && M.win && Y.readyState != 4) {
            ...
            (function() { if (Y.readyState == 4) { Y.parentNode.removeChild(Y) } else { setTimeout(arguments.callee, 10) } })()
    ...
    function u(ai, ag, Y) {
        ...
        if (aa) {
            ...
            if (M.ie && M.win) {
                var ah = "";
                for (var ae in ai) { if (ai[ae] != Object.prototype[ae]) { if (ae.toLowerCase() == "data") { ag.movie = ai[ae] } else { if (ae.toLowerCase() == "styleclass") { ah += ' class="' + ai[ae] + '"' } else { if (ae.toLowerCase() != "classid") { ah += " " + ae + '="' + ai[ae] + '"' } } } } }
                var af = "";
    ...
    function b(Z) {
        var Y = c(Z);
        if (Y) {
            for (var X in Y) { if (typeof Y[X] == "function") { Y[X] = null } }
    ...
    return {
        ...
        createSWF: function(Z, Y, X) { if (M.w3) { return u(Z, Y, X) } else { return undefined } },
        ...
        expressInstallCallback: function() {
            if (a) {
                var X = c(R);
                if (X && l) { X.parentNode.replaceChild(l, X); if (Q) { w(Q, true); if (M.ie && M.win) { l.style.display = "block" } } if (E) { E(B) } }
                a = false
            }
        }
    }
